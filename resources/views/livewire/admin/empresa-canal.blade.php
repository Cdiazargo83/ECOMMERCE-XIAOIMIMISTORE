<!-- resources/views/livewire/empresa-canal.blade.php -->
<div>
        ...
        <div class="bg-white shadow-xl rounded-lg p-6">
            <form wire:submit.prevent="guardar">
                ...
                <div class="mb-4">
                    ...
                    <x-jet-input type="text" class="w-full" wire:model="empresa" placeholder="Ingrese Empresa" />
                ...
                <div class="mb-4">
                    ...
                    <select class="w-full form-control" wire:model="pais_id">
                        <option value="" selected disabled>Selecione una Pais</option>
                ...
                <div class="mb-4">
                    ...
                    <select class="w-full form-control" wire:model="moneda_id">
                        <option value="0" selected disabled>Selecione una Moneda</option>
    ...
    <br>
    <div>
        <h2>Lista de Empresas y Canales:</h2>
            ...
            <tbody>
                @foreach ($empresasCanales as $empresaCanal)
                    <tr>
                        ...
                        <td style="padding: 8px; border: 1px solid #ddd;">{{ $empresaCanal->nombre_comercial }}
                        </td>
                        ...
                        <td style="padding: 8px; border: 1px solid #ddd;">{{ $empresaCanal->pais->desc_pais }}
                        </td>
                        <td style="padding: 8px; border: 1px solid #ddd;">
                            {{ $empresaCanal->moneda->desc_moneda }}
                        </td>
                    </tr>
                @endforeach
            </tbody>
