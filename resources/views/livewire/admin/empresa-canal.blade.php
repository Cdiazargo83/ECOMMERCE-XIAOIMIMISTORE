        ...
        <div class="bg-white shadow-xl rounded-lg p-6">
            <form wire:submit.prevent="guardar" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="mb-4">
                    ...
                    <x-jet-input type="text" class="w-full" wire:model="desc_empresa" placeholder="Ingrese Desc. Empresa" />
                ...
                <div class="mb-4">
                    ...
                    <x-jet-input type="text" class="w-full" wire:model="nombre_comercial" placeholder="Ingrese Nombre Comercial" />
