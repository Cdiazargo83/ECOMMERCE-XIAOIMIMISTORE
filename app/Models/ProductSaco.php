...
class ProductSaco extends Model
{
    protected $fillable = [
        'sku', 'name', 'slug', 'description', 'price', 'subcategory_id', 'brand_id',
        'quantity', 'status','chbitel'
    ];

    protected $bodegaColumns = ['chbitel'];

    protected $table = 'products_saco';
